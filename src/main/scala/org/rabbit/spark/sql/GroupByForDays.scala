...
object GroupByForDays {
  ...
  val spark = SparkSession
    ...
    .appName("myApp")
    .master("local[*]")
//    .config("org.rabbit.spark.redis.host", "172.19.22.136")
//    .config("org.rabbit.spark.redis.port", "6379")
//    .config("org.rabbit.spark.redis.auth", "qile123")
    .getOrCreate()
...
//
//    )
//    org.rabbit.spark.createDataFrame(orders).toDF("order_id", "member_id", "m_code","order_time", "price")
//      .createOrReplaceTempView("orders")
//
//
//    org.rabbit.spark.sql(
//      """
//        |
...
//    org.rabbit.spark.createDataFrame(lives).toDF("order_id", "member_id", "m_code","order_time", "price")
//      .createOrReplaceTempView("lives")
//
//
//    val df=org.rabbit.spark.sql(
//      """
//        |
//        |with d as (
...
//    df.show()
//      .write
//      .format("org.apache.org.rabbit.spark.sql.redis")
//      .option("table", "foo")
//      .save()
//      .show()
